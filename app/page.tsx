...
const PROFILE = {
  name: "Ayushi Gupta",
  title: "Frontend Engineer & Website Developer",
  tagline:
    "I build fast, modern, mobile-first websites that help businesses look premium and get more leads.",
  location: "Gurgaon, India",
  phone: "+91 8528414071",
  email: "ayushi.rgupta74@gmail.com",
  linkedin: "https://linkedin.com/in/ayushi-gupta-89861315b",
  // optional:
  github: "", // add if you want
...
const SERVICES = [
  {
    ...
    title: "Business Website (5–8 pages)",
    desc: "A premium website for your business: Home, About, Services, Gallery, Contact + WhatsApp + Map.",
    points: ["Mobile responsive", "Fast loading", "Lead-focused layout"],
  },
  {
    icon: <Globe className="h-5 w-5" />,
    title: "Landing Page (High Conversion)",
    desc: "Single-page website designed to convert visitors into calls/WhatsApp leads.",
    points: ["Strong CTA sections", "Trust & reviews", "Offer/pricing blocks"],
  },
  {
    icon: <Zap className="h-5 w-5" />,
    title: "Website Revamp / Speed Fix",
    desc: "Upgrade old websites with modern UI, better performance, and clean structure.",
    points: ["UI modernization", "Performance optimization", "SEO basics"],
  },
  {
    icon: <Wrench className="h-5 w-5" />,
    title: "Deploy + Domain Setup",
    desc: "Vercel deployment, custom domain, SSL, and professional setup support.",
    points: ["Vercel deploy", "Custom domain", "Business email guidance"],
  },
];
...
const PORTFOLIO = [
  {
    ...
    tech: "Node.js • React • MongoDB • Bootstrap • Stripe • SMTP • REST",
    bullets: [
      "Centralized platform for members to register, log complaints, and track maintenance dues.",
      "Stripe payments + automated email alerts via SMTP.",
      "Responsive UI and real-time updates via REST APIs.",
    ],
    live: "",
    code: "",
  },
  {
    title: "Home Services of India",
    tech: "Node.js • MongoDB • HTML • Bootstrap • REST",
    bullets: [
      "Household service aggregator for booking electricians, plumbers, and more.",
      "Booking forms, service listings, and admin panels for scheduling/tracking.",
      "Secure data handling with user-friendly flows.",
    ],
    live: "",
    code: "",
  },
...
const EXPERIENCE = [
  {
    ...
    company: "Incedo • Gurgaon",
    period: "Mar 2023 – Present",
    points: [
      "Built and enhanced a scalable Knowledge Management System using React, Material UI, and TypeScript for 500+ internal users.",
      "Led upgrade from React 16 to 18: fixed UI breakages, replaced deprecated lifecycles with hooks, modernized libraries.",
      "Created dashboards for logistics teams using React + Bootstrap, improving delivery tracking efficiency by ~35%.",
      "Worked with backend teams on REST APIs and improved response times by ~25%.",
      "Used AI-assisted development tools to speed up component scaffolding and refactors.",
    ],
  },
  {
    role: "Software Engineer",
    ...
    points: [
      "Improved role-based dashboards for a healthcare client using React and Bootstrap, reducing manual reporting time by ~30%.",
      "Implemented localization with i18next to support multi-region and multi-language scaling.",
    ],
  },
  {
    role: "Software Engineer (Front-End)",
    company: "App-Stone • Lucknow",
    period: "Oct 2021 – Jul 2022",
    points: [
      "Expanded front-end for an internal health tracking system using React and Material UI.",
      "Built real-time appointment booking with live doctor availability using REST + GraphQL APIs.",
      "Implemented efficient GraphQL integrations for fetch/update flows.",
    ],
  },
];
...
function PrimaryButton({
  ...
  return (
    <a
      href={href}
      className="inline-flex items-center justify-center gap-2 rounded-xl bg-white px-4 py-2.5 text-sm font-semibold text-black shadow-sm transition hover:opacity-90"
    >
      {children}
...
function Card({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl border border-white/10 bg-white/[0.04] p-5 shadow-[0_0_0_1px_rgba(255,255,255,0.02)] backdrop-blur",
        className
      )}
    >
      {children}
...
export default function Page() {
  const whatsappLink = `https://wa.me/${PROFILE.phone.replace(/\D/g, "")}?text=${encodeURIComponent(
    "Hi Ayushi, I found your website. I want a professional business website. Please share details."
  )}`;
  ...
  return (
    <div className="min-h-screen bg-[#070A12] text-white">
      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        <div className="absolute -top-40 left-1/2 h-[520px] w-[520px] -translate-x-1/2 rounded-full bg-[radial-gradient(circle,rgba(120,119,198,0.28),transparent_60%)] blur-2xl" />
        <div className="absolute -bottom-52 right-[-120px] h-[520px] w-[520px] rounded-full bg-[radial-gradient(circle,rgba(56,189,248,0.22),transparent_60%)] blur-2xl" />
      </div>
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-3">
          <a href="#top" className="flex items-center gap-2">
            ...
            <div className="leading-tight">
              ...
              <div className="text-xs text-white/60">Websites that convert</div>
            </div>
          </a>
          ...
          <div className="flex items-center gap-2">
            <a
              href={whatsappLink}
              className="hidden rounded-xl border border-white/10 bg-white/5 px-4 py-2 text-sm font-semibold text-white hover:bg-white/10 sm:inline-flex"
            >
              WhatsApp
            </a>
            <a
      ...
      {/* HERO */}
      <main id="top" className="mx-auto max-w-6xl px-5 pb-8 pt-10 sm:pt-14">
        <motion.div
          variants={container}
          initial="hidden"
          animate="visible"
        ...
        >
          <motion.div variants={fadeUp}>
            ...
            <h1 className="text-3xl font-semibold tracking-tight sm:text-5xl">
              {PROFILE.title}
              <span className="block text-white/70">{PROFILE.name}</span>
            </h1>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <PrimaryButton href="#portfolio">See Work</PrimaryButton>
              <GhostButton href={whatsappLink}>WhatsApp</GhostButton>
            ...
            <div className="mt-8 grid gap-2 sm:grid-cols-2">
              ...
              <IconLine
                ...
                text="linkedin.com/in/ayushi-gupta-89861315b"
          ...
          <motion.div variants={fadeUp} className="lg:pt-2">
            <Card className="relative overflow-hidden">
              <div className="absolute -right-20 -top-20 h-52 w-52 rounded-full bg-[radial-gradient(circle,rgba(255,255,255,0.10),transparent_60%)] blur-2xl" />
              <div className="relative">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="text-sm text-white/60">Client-ready offer</div>
                    <div className="mt-1 text-lg font-semibold">
                      Premium Website in 3–7 Days
                    </div>
                  </div>
                ...
                <div className="mt-4 space-y-3">
                  {[
                    "Modern premium design (mobile-first)",
                    "WhatsApp + Contact Form + Google Map",
                    "Fast loading + basic SEO setup",
                    "Hosting + domain deployment support",
                  ].map((t) => (
                    <div key={t} className="flex gap-2 text-sm text-white/75">
                ...
                <a
                  href={whatsappLink}
                  className="mt-5 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-white px-4 py-2.5 text-sm font-semibold text-black hover:opacity-90"
                >
                  Message on WhatsApp
                  <ArrowRight className="h-4 w-4" />
                </a>
                ...
                <div className="mt-3 text-center text-xs text-white/50">
                  Quick reply • Professional delivery • Clear pricing
                </div>
              </div>
            </Card>
            ...
            <div className="mt-4 grid grid-cols-3 gap-3">
              <Card className="p-4 text-center">
                ...
                <div className="mt-1 text-sm font-semibold">UI + Speed</div>
              </Card>
              <Card className="p-4 text-center">
                <div className="text-xs text-white/60">Stack</div>
                <div className="mt-1 text-sm font-semibold">React / Next</div>
              </Card>
              <Card className="p-4 text-center">
                <div className="text-xs text-white/60">Delivery</div>
                <div className="mt-1 text-sm font-semibold">Fast</div>
              </Card>
            </div>
          </motion.div>
        </motion.div>
      ...
      {/* SERVICES */}
      <Section id="services" title="Services" kicker="What I can build for your business">
        <motion.div
          variants={container}
          initial="hidden"
          whileInView="visible"
            ...
            <motion.div key={s.title} variants={fadeUp}>
              <Card className="h-full">
                <div className="flex items-start justify-between gap-4">
                  <div>
                    <div className="inline-flex items-center gap-2 rounded-xl border border-white/10 bg-white/5 px-3 py-1 text-xs text-white/70">
                      {s.icon}
                      <span>Service</span>
                    </div>
                ...
                <div className="mt-4 space-y-2">
                  {s.points.map((p) => (
                    <div key={p} className="flex gap-2 text-sm text-white/75">
                      <CheckCircle2 className="mt-0.5 h-4 w-4 text-white/70" />
                      <span>{p}</span>
                    </div>
                  ))}
        ...
        <div className="mt-6">
          <Card className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <div className="text-sm text-white/60">Want to start quickly?</div>
              <div className="mt-1 text-base font-semibold">
                I can show 2–3 demo designs on WhatsApp.
              </div>
            </div>
            <a
              href={whatsappLink}
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-white px-4 py-2.5 text-sm font-semibold text-black hover:opacity-90"
            >
              Ask for Demo
              <ArrowRight className="h-4 w-4" />
            </a>
      ...
      <Section id="portfolio" title="Portfolio" kicker="Selected work">
              ...
              <Card className="h-full">
                <div className="flex items-start justify-between gap-4">
                  <div>
                    ...
                    <p className="mt-2 text-xs text-white/60">{p.tech}</p>
                  </div>
                  <div className="grid h-10 w-10 place-items-center rounded-2xl border border-white/10 bg-white/5">
                ...
                <div className="mt-5 flex flex-wrap gap-2">
                  {p.live ? (
                    <GhostButton href={p.live}>Live</GhostButton>
                  ) : (
                  ...
                  {p.code ? (
                    <GhostButton href={p.code}>Code</GhostButton>
                  ) : (
                    <span className="rounded-xl border border-white/10 bg-white/5 px-3 py-2 text-xs text-white/60">
                      Add GitHub Link
                    </span>
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2">
          <Card>
            <div className="text-sm text-white/60">Tip for getting clients</div>
            <div className="mt-1 text-base font-semibold">
              Add 2–3 Demo Websites (Templates)
            </div>
            <p className="mt-2 text-sm text-white/70">
              Even if you have no clients yet, demos help you sell faster:
          ...
          <Card>
            <div className="text-sm text-white/60">Your selling weapon</div>
            <div className="mt-1 text-base font-semibold">
              Share this link + WhatsApp CTA
            </div>
            <p className="mt-2 text-sm text-white/70">
              When you contact businesses, send this website link. It builds
              trust and closes deals faster.
            </p>
          </Card>
        </div>
      </Section>
      ...
      {/* EXPERIENCE */}
      <Section id="experience" title="Experience" kicker="Work timeline">
            ...
            <Card key={e.role + e.company}>
              <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                <div>
                  ...
                  <div className="mt-1 text-sm text-white/70">{e.company}</div>
                </div>
      ...
      {/* SKILLS + CERTS */}
      <Section id="skills" title="Skills & Certifications" kicker="What I use">
        <div className="grid gap-4 lg:grid-cols-2">
          ...
          <Card>
            ...
            <div className="mt-4 space-y-2">
              {CERTS.map((c) => (
                <div key={c} className="flex gap-2 text-sm text-white/75">
            ...
            <div className="mt-5 rounded-2xl border border-white/10 bg-white/5 p-4">
              ...
              <p className="mt-2 text-sm text-white/70">
                Also comfortable with i18n, dashboards, and clean component
                architecture.
              </p>
            </div>
          </Card>
      ...
      {/* CONTACT */}
      <Section id="contact" title="Contact" kicker="Let’s build your website">
        <div className="grid gap-4 lg:grid-cols-[1.1fr_0.9fr]">
          <Card>
            <h3 className="text-lg font-semibold">Get a quote</h3>
            <p className="mt-2 text-sm text-white/70">
              Tell me your business type (gym/clinic/restaurant/coaching etc.)
              and I’ll share a demo design + pricing.
            </p>
          ...
          <Card>
            ...
            <div className="mt-4 grid gap-2">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center justify-between rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-white/80 hover:bg-white/10"
              >
            ...
            <div className="mt-6 rounded-2xl border border-white/10 bg-white/5 p-4">
              <div className="text-sm font-semibold">Client Pitch Line</div>
              <p className="mt-2 text-sm text-white/70">
                “I noticed your business doesn’t have a website yet. I can build
                a premium mobile-friendly website that brings more customers from
                Google.”
              </p>
            </div>
          </Card>
      ...
      <a
        href={whatsappLink}
        className="fixed bottom-5 right-5 z-50 inline-flex items-center gap-2 rounded-2xl bg-white px-4 py-3 text-sm font-semibold text-black shadow-lg hover:opacity-90"
      >
        WhatsApp
        <ArrowRight className="h-4 w-4" />
      </a>
